...
public final class AnimatableIdCache extends SavedData {
	...
	private AnimatableIdCache(CompoundTag tag, HolderLookup.Provider registryProvider) {
	...
	@Override
	public CompoundTag save(CompoundTag tag, HolderLookup.Provider registryProvider){
